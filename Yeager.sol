...
contract YeagerInu is Context, IERC20Metadata, Ownable {
    ...
    constructor (address wallet1_,  address wallet2_) {
        ...
        */
        _totalTaxPercent = 10;  
        _governingTaxes = governingTaxes(10, 20, 50, 20, wallet1_, wallet2_); 
    ...
    function setTaxes(
        ...
        require(totalTaxPercent_ <= 10, "Total Tax Percent Exceeded 10% !"); // Prevents owner from manipulating Tax.
